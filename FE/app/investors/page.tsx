...
export default function InvestorsPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 px-4 md:px-8 max-w-7xl mx-auto">
        ...
        <div className="text-center mt-8">
          <Button className="bg-blue-600 hover:bg-blue-700">
            <Link href="/investors/reports">Xem tất cả báo cáo tài chính</Link>
          </Button>
        </div>
      </section>
      ...
      <section className="py-12 px-4 md:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold mb-8">Thông báo cổ đông</h2>
          <div className="space-y-4">
            {shareholderAnnouncements.map((announcement) => (
              <Card key={announcement.id} className="border-0 shadow-md hover:shadow-lg transition-shadow">
                <CardContent className="p-4">
                  ...
                  <Button variant="ghost" className="text-blue-600 hover:text-blue-800 p-0">
                    <Link href={`/investors/announcements/${announcement.id}`} className="flex items-center">
                      Xem chi tiết <ArrowUpRight className="ml-1 h-4 w-4" />
                    </Link>
                  </Button>
                </CardContent>
              </Card>
          ...
          <div className="text-center mt-8">
            <Button className="bg-blue-600 hover:bg-blue-700">
              <Link href="/investors/announcements">Xem tất cả thông báo</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 md:px-8 max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold mb-8">Quản trị doanh nghiệp</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold mb-4">Hội đồng quản trị</h3>
              <p className="text-gray-600 mb-4">
                Thông tin về thành viên Hội đồng quản trị, vai trò và trách nhiệm của họ trong việc định hướng chiến
                lược của công ty.
              </p>
              <Button variant="outline" className="w-full">
                <Link href="/investors/board">Xem chi tiết</Link>
              </Button>
            </CardContent>
          </Card>
          <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold mb-4">Điều lệ & Quy chế</h3>
              <p className="text-gray-600 mb-4">
                Điều lệ công ty, quy chế quản trị nội bộ và các tài liệu pháp lý quan trọng khác liên quan đến quản trị
                doanh nghiệp.
              </p>
              <Button variant="outline" className="w-full">
                <Link href="/investors/governance">Xem chi tiết</Link>
              </Button>
            </CardContent>
          </Card>
          <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold mb-4">Đại hội đồng cổ đông</h3>
              <p className="text-gray-600 mb-4">
                Thông tin về các kỳ Đại hội đồng cổ đông, tài liệu họp, biên bản và nghị quyết của các kỳ đại hội.
              </p>
              <Button variant="outline" className="w-full">
                <Link href="/investors/meetings">Xem chi tiết</Link>
              </Button>
            </CardContent>
          </Card>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="outline" className="text-white border-white hover:bg-blue-700">
                <Link href="/investors/contact">Gửi yêu cầu</Link>
              </Button>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 px-4 md:px-8 max-w-7xl mx-auto">
        <div className="bg-gray-50 rounded-xl p-6 md:p-8 text-center">
          <h2 className="text-2xl font-bold mb-2">Đăng ký nhận thông báo</h2>
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Đăng ký để nhận thông báo về báo cáo tài chính, thông báo cổ đông và các tin tức quan trọng khác từ
            HotelBooking.
          </p>
