...
// Định nghĩa giao diện cho phản hồi Facebook
...
// Lấy client ID và base URL từ biến môi trường
const GOOGLE_CLIENT_ID = process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID || "532529572983-t6vt7gpm75pqdpfq13gj6i5dv7d77ft8.apps.googleusercontent.com";
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await login(data); // Chỉ truyền data
