...
export function SearchBarRedesign() {
  ...
  const handleSearch = () => {
    // Redirect to destination page (for demo purposes, we'll use Da Nang)
    router.push("/destinations/da-nang")
  }
  ...
  return (
    <div className="bg-white rounded-xl shadow-2xl p-4 md:p-6 max-w-6xl mx-auto -mt-16 relative z-10">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Popover open={isCalendarOpen} onOpenChange={setIsCalendarOpen}>
          <PopoverTrigger asChild>
            <Button
              variant="outline"
              className="w-full justify-start text-left font-normal h-12 border-2 border-gray-200 hover:border-blue-500"
            >
        ...
        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
          <Button
            className="w-full bg-blue-600 hover:bg-blue-700 text-white h-12 rounded-lg font-medium text-base"
